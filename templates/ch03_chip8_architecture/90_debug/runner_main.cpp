// runner_main.cpp — headless trace runner for the debugging exercise.
//
//   ch03_90_debug_runner --rom FILE [--headless] [--cycles N] [--frames N]
//                        [--trace FILE]
//
// Trace lines follow the chapter format (see LECTURE.md); compare against
// tests/public/ch03_chip8_architecture/traces/ with tools/labs/compare_trace.py.
#include <cstdio>
#include <cstdlib>
#include <fstream>
#include <iterator>
