#pragma once
// ch06 reference CHIP-8 core (complete; provided to the student).
//
// This chapter is about *observing* an emulator, not building one from
// scratch: tracing, breakpoints, stepping and quirk profiles all sit on top
// of this small interpreter. The quirk flags are declared here because the
// historical behavior differences they model show up inside step() itself.
