...
//@LABS-BEGIN 1
//@LABS-SOLUTION
    t[0x1D] = {mode_absx, op_ora, 4, Penalty::OnCross};
    t[0x39] = {mode_absy, op_and, 4, Penalty::OnCross};
//@LABS-STUB
    // TODO(1): ORA abs,X ($1D, 4+1 on cross) and AND abs,Y ($39, 4+1 on cross).
//@LABS-END
...
//@LABS-BEGIN 2
//@LABS-SOLUTION
    t[0x41] = {mode_izx, op_eor, 6, Penalty::Always};
    t[0x75] = {mode_zpx, op_adc, 4, Penalty::Always};
//@LABS-STUB
    // TODO(2): EOR (zp,X) ($41, 6 cycles, penalty ALWAYS - the zero-page
    // pointer read costs an extra access) and ADC zp,X ($75, 4, ALWAYS).
//@LABS-END
...
//@LABS-BEGIN 3
//@LABS-SOLUTION
    t[0xFD] = {mode_absx, op_sbc, 4, Penalty::OnCross};
    t[0xD1] = {mode_izy, op_cmp, 5, Penalty::OnCross};
//@LABS-STUB
    // TODO(3): SBC abs,X ($FD, 4+1 on cross) and CMP (zp),Y ($D1, 5+1 on cross).
//@LABS-END
...
//@LABS-BEGIN 4
//@LABS-SOLUTION
    t[0xFE] = {mode_absx, op_inc, 7, Penalty::Always};
    t[0xDE] = {mode_absx, op_dec, 7, Penalty::Always};
//@LABS-STUB
    // TODO(4): INC abs,X ($FE) and DEC abs.X ($DE): 7 cycles, penalty
    // ALWAYS - indexed RMW never skips the speculative access.
//@LABS-END
...
//@LABS-BEGIN 5
//@LABS-SOLUTION
    t[0x76] = {mode_zpx, op_ror, 6, Penalty::Always};
    t[0x24] = {mode_zp, op_bit, 3};
//@LABS-STUB
    // TODO(5): ROR zp,X ($76, 6 cycles, ALWAYS) and BIT zp ($24, 3 cycles).
//@LABS-END
