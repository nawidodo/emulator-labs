#pragma once
//
// ch40 / 01_irq_controller — PS1 interrupt controller register model
...
public:
    ...
    //@LABS-STUB
    void raise(uint32_t /*lines*/) {
        // TODO(1): record the asserted level and latch the request bits
    ...
    //@LABS-STUB
    void ack(uint32_t /*value*/) {
        // TODO(2): clear only the acknowledged bits out of the status
        // register, then re-latch any source whose line is still held.
    }
    //@LABS-END
    ...
    //@LABS-STUB
    bool irq_out() const {
        // TODO(3): true when at least one ENABLED source is latched.
        return false;
    }
    //@LABS-END
