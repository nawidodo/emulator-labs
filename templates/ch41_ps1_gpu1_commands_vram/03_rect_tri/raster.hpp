...
//@LABS-STUB
// TODO(1): clip to the drawing area, skip write-protected destinations when
// check_mask is set, and store the 15-bit color (plus forced bit15 when
// set_mask is set).
inline void write_pixel(Vram&, const DrawConfig&, int, int, uint32_t) {
    // wrong on purpose: draws nothing
}
//@LABS-END
...
//@LABS-STUB
// TODO(2): normalise the size fields (0 means maximum!), apply the drawing
// offset and stamp every pixel through write_pixel().
...
//@LABS-STUB
// TODO(3): return the cross product (b-a) x (c-a) as 64-bit.
...
//@LABS-STUB
// TODO(4): implement the rule above.
...
//@LABS-STUB
// TODO(5): cull non-positive area, build the three lattice edge functions
...
//@LABS-STUB
// TODO(6): implement the Q12 barycentric walk documented above (same edge
...
//@LABS-STUB
// TODO(7): weighted sum of the three endpoint channels in Q12 with
